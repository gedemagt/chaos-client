...
import static com.codename1.util.BigInteger.*;
...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
    ...
    public static UUID randomUUID() {
        ...
        int i = 0;
        while(i<16) {
            byte[] array = BigInteger.valueOf(ng.nextInt()).toByteArray();
            for(int j=0; j<array.length && i<16; i++, j++) {
                randomBytes[i] = array[j];
            }
        }
